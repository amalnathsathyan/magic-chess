...
```
https://explorer.solana.com/address/F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe?cluster=devnet
```
...
```bash
anchor idl init F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe \
...
```bash
anchor idl fetch F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe --provider.cluster devnet
```
...
```bash
anchor idl upgrade F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe \
  --filepath target/idl/magic_chess.json \
  --provider.cluster devnet
```
...
[programs.devnet]
magic_chess = "F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe"
...
Program ID (devnet): `F8MMYzGxdXdtKTkGqUJvDrmTWm8bBb1zyajLT1s5tpMe`
